  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      <KPICard
        ...
        value={fmt(data.total_spend, "currency")}
        color="blue"
      ...
      <KPICard
        label="Impressões"
        value={fmt(data.total_impressions)}
        color="purple"
      ...
      <KPICard
        label="Leads"
        value={fmt(data.total_leads)}
        color="orange"
        icon={<LeadsIcon />}
      />
      <KPICard
        label="CPC"
        value={fmt(data.cpc, "currency")}
        color="blue"
        subtext="Custo por Clique"
      />
      <KPICard
        label="CPM"
        value={fmt(data.cpm, "currency")}
        color="purple"
        subtext="por 1.000 impressões"
      />
      <KPICard
        label="CTR"
        value={fmt(data.ctr, "percent")}
        color="green"
        subtext="Click-Through Rate"
      />
      <KPICard
        label="CPL"
        value={fmt(data.cpl, "currency")}
        color="orange"
